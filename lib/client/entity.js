...
JSG.Entity = class extends ETClass
  {
   addProp(name, val)
    ...
    constructor()
	{
		...
		this.prototype.speed_x = 0;
		this.prototype.speed_y = 0;
		this.prototype.speed=0;
		Object.defineProperty(this.prototype, 'x', { set: function(x) { this.element.x=x }, get: function() { return this.element.x } });
		Object.defineProperty(this.prototype, 'y', { set: function(y) { this.element.y=y }, get: function() { return this.element.y } });
